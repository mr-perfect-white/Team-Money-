                ...
                <form id="groupForm"  action="{{route('teamMeeting.update',['teamMeeting'=>$teamMeeting->id])}}" method="POST" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="date" name="tm_mtng_date" type="date" value="{{$teamMeeting->date}}"  placeholder="Select date"  required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="time" name="tm_mtng_time" type="time" value="{{$teamMeeting->time}}"  placeholder="Enter Time" required>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="mt-4 m-checkbox-inline custom-radio-ml">
                                ...
                                <input class="form-check-input memberYes" id="radioinline1" type="radio" name="tm_mtng_mode" value="Online">
                                <label class="form-check-label mb-0" for="radioinline1">Online Meeting<span class="digits"> </span></label>
                                </div>
                                <div class="form-check form-check-inline radio radio-primary" id="">
                                <input class="form-check-input memberNo" id="radioinline2" type="radio" name="tm_mtng_mode" value="Offline">
                        ...
                        <div class="col-md-6 mb-3 meetingurl" id="" style="display:none;">
                            ...
                            <input class="form-control" id="validationDefault01" type="url" name="mtng_url" placeholder="Enter Meeting URL">
                        </div>
                        <div class="col-md-6 mb-3 meetingaddress" id="" style="display:none;">
                                ...
                                <textarea class="form-control" id="validationDefault01" type="text" name="mtng_aadr" placeholder="Enter Meeting Address"></textarea>
                        </div>
