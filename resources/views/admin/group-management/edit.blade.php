...
<form action="{{route('group.update',['group'=>$group->id])}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <!-- <input class="form-control" type="hidden" name="old_logo" value="{{$group->logo}}"> -->
                                <input class="form-control" type="file" name="logo">

                                <a class="mt-2" href="{{asset('uploads/group-logos/'.$group->logo)}}" target="_blank">                                
                                  <img src="{{asset('uploads/group-logos/'.$group->logo)}}" style="height:100px;width:100px;">
                                </a>                              
                              </div>
