<div class="footer card card-style mx-3 mb-0">
            <a href="#" class="footer-title pt-4">Team Money</a>
            <p class="text-center font-12 mt-n1 mb-3 opacity-70">
               A path to Economic Freedom
            </p>
            <p class="boxed-text-l">
                Together, We save, grow and empower each other to achieve independence & shared prosperity
            </p>
